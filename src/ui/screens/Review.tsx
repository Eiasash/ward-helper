...
export function Review() {
  ...
  // SOAP would be a stub (PATIENT case — no clinical content extracted),
   ...
   * vitals reading. Otherwise the emit produces a PATIENT-style stub
  ...
  return (
    <section>
      ...
      {(() => {
        ...
        // a PATIENT-style stub. Replace the bare Proceed button with
